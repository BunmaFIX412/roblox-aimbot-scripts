...
toggleAimbot.MouseButton1Click:Connect(function()
    ...
    toggleAimbot.Text = "Aimbot: " .. (AIMBOT_ENABLED and "ON (X)" or "OFF (X)")
    toggleAimbot.BackgroundColor3 = AIMBOT_ENABLED and Color3.fromRGB(0, 200, 0) or Color3.fromRGB(200, 50, 50)
end)
